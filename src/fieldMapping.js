...
export const FIELD_MAPPING = {
  ...
  // Настройки сделок
  lead: {
    pipelineId: process.env.AMO_PIPELINE_ID ? Number(process.env.AMO_PIPELINE_ID) : null,  // ID воронки
    statusId: process.env.AMO_STATUS_ID ? Number(process.env.AMO_STATUS_ID) : null,          // ID этапа
  },
};
